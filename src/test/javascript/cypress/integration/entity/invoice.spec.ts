...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    date: '2022-01-10T06:39:41.741Z',
    status: 'ISSUED',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2022-01-10T17:38:14.319Z',
    paymentAmount: 75679,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      cy.get(`[data-cy="date"]`).type('2022-01-10T07:37').should('have.value', '2022-01-10T07:37');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2022-01-10T02:54').should('have.value', '2022-01-10T02:54');
