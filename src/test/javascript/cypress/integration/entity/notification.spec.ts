...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2022-01-10T09:57:24.480Z',
    sentDate: '2022-01-10T02:10:27.824Z',
    format: 'PARCEL',
    userId: 94565,
    productId: 69326,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2022-01-09T18:15').should('have.value', '2022-01-09T18:15');

      cy.get(`[data-cy="details"]`).type('calculate').should('have.value', 'calculate');

      cy.get(`[data-cy="sentDate"]`).type('2022-01-09T18:19').should('have.value', '2022-01-09T18:19');
