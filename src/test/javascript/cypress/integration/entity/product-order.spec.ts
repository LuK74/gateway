...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2022-01-10T06:07:12.728Z', status: 'COMPLETED', code: 'paradigm Account adapter' };
  ...
  describe('new ProductOrder page', () => {
    ...
    it('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2022-01-10T12:29').should('have.value', '2022-01-10T12:29');
